...
public class ProjetoControle {
    ...
    public ModelAndView cadastrar() {
        ...
        modelAndView.addObject("lideres", funcionarioRepositorio.findByCargoNome("Gerente de Projeto"));
        modelAndView.addObject("funcionarios", funcionarioRepositorio.findByCargoNomeNot("Gerente de Projeto"));
